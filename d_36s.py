...
def Network():
    ...
    net.get('s8').start([c1,c2])
    net.get('s9').start([c1,c2])
    net.get('s10').start([c1,c2])
    net.get('s11').start([c1,c2])
    net.get('s12').start([c1,c2])
    net.get('s13').start([c1,c2])
    net.get('s14').start([c1,c2])
    net.get('s15').start([c1,c2])
    net.get('s16').start([c1,c2])
    net.get('s17').start([c1,c2])
    net.get('s18').start([c1,c2])
    net.get('s19').start([c2,c1])
    net.get('s20').start([c2,c1])
    net.get('s21').start([c2,c1])
    net.get('s22').start([c2,c1])
    net.get('s23').start([c2,c1])
    net.get('s24').start([c2,c1])
    net.get('s25').start([c2,c1])
    net.get('s26').start([c2,c1])
    net.get('s27').start([c2,c1])
    net.get('s28').start([c2,c1])
    net.get('s29').start([c2,c1])
    net.get('s30').start([c2,c1])
    net.get('s31').start([c2,c1])
    net.get('s32').start([c2,c1])
    net.get('s33').start([c2,c1])
    net.get('s34').start([c2,c1])
    net.get('s35').start([c2,c1])
    net.get('s36').start([c2,c1])
