...
def Network():
    ...
    net.get('s101').start([c2])
    net.get('s102').start([c2])
    net.get('s103').start([c2])
    net.get('s104').start([c2])
    net.get('s105').start([c2])
    net.get('s106').start([c2])
    net.get('s107').start([c2])
    net.get('s108').start([c2])
    net.get('s109').start([c2])
    net.get('s110').start([c2])
    net.get('s111').start([c2])
    net.get('s112').start([c2])
    net.get('s113').start([c2])
    net.get('s114').start([c2])
    net.get('s115').start([c2])
    net.get('s116').start([c2])
    net.get('s117').start([c2])
    net.get('s118').start([c2])
    net.get('s119').start([c2])
    net.get('s120').start([c2])
    net.get('s121').start([c2])
    net.get('s122').start([c2])
    net.get('s123').start([c2])
    net.get('s124').start([c2])
    net.get('s125').start([c2])
